...
def load_projects_from_file(file_path: str = "projects.txt") -> List[Dict]:
    """从文件加载项目列表"""
    try:
        projects = []
...
def main():
    ...
    try:
        ...
        analyzer = GitWorkflowAnalyzer(projects_base_path=repos_path)
