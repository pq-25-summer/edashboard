    ...
    async with db.cursor() as cur:
        ...
        for row in results:
            project_statuses.append({
                ...
                "commits_with_issue_refs": row.get("commits_with_issue_refs", 0),
                "commits_without_issue_refs": row.get("commits_without_issue_refs", 0),
                "issues_with_assignees": row.get("issues_with_assignees", 0),
                "issues_without_assignees": row.get("issues_without_assignees", 0),
                "closed_issues": row.get("closed_issues", 0),
                "open_issues": row.get("open_issues", 0),
                "commit_issue_ratio": float(row.get("commit_issue_ratio", 0)),
                "issue_assignee_ratio": float(row.get("issue_assignee_ratio", 0)),
                "issue_closure_ratio": float(row.get("issue_closure_ratio", 0)),
                "uses_issue_driven_development": row.get("uses_issue_driven_development", False),
                "issue_driven_score": float(row.get("issue_driven_score", 0)),
                "issue_workflow_quality": row.get("issue_workflow_quality", "一般"),
...
async def get_project_status(project_id: int, db=Depends(get_db)):
    ...
    async with db.cursor() as cur:
        ...
        return {
            ...
            "commits_with_issue_refs": result.get("commits_with_issue_refs", 0),
            "commits_without_issue_refs": result.get("commits_without_issue_refs", 0),
            "issues_with_assignees": result.get("issues_with_assignees", 0),
            "issues_without_assignees": result.get("issues_without_assignees", 0),
            "closed_issues": result.get("closed_issues", 0),
            "open_issues": result.get("open_issues", 0),
            "commit_issue_ratio": float(result.get("commit_issue_ratio", 0)),
            "issue_assignee_ratio": float(result.get("issue_assignee_ratio", 0)),
            "issue_closure_ratio": float(result.get("issue_closure_ratio", 0)),
            "uses_issue_driven_development": result.get("uses_issue_driven_development", False),
            "issue_driven_score": float(result.get("issue_driven_score", 0)),
            "issue_workflow_quality": result.get("issue_workflow_quality", "一般"),
